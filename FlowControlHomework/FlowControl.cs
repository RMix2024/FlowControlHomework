...
namespace FlowControlHomework
{
    ...
    public class FlowControlHomework
    {
        ...
        public void IfFundementals() // THE GOAL IS TO CHANGE THE FLOW TO REACH ALL THE PASSING STATEMENTS AND TO FIX COMPILATION ISSUES
        {
            ...
            changeFlow = true; // assign me so I can reach line 27 in my flow of execution
            if (changeFlow)
            {
                //Assert.IsTrue(false);
            }
        ...
        public void IfWithOperators()
        {
            ...
            int students = 16;
            if (/*operand here*/students == 16/*operand here*/)
            {
                Assert.IsTrue(true);
            }
            else
            ...
            if (/*operand here*/students != 17/*operand here*/)
            {
                Assert.IsTrue(true);
            }
            else
            ...
            if (/*operand here*/students > 10/*operand here*/)
            {
                Assert.IsTrue(true);
            }
            else
            ...
            if (! (students>16)/*operand here, do not remove not operator*/)
            {
                Assert.IsTrue(true);
            }
            else
            ...
            if (!! (students>19)/*operand here, do not remove double not operator*/)
            {
                Assert.IsTrue(true);
            }
            else
            ...
            int instructors = 1;
            if ((/*operand here*/students == 16/*operand here*/) && (/*operand here*/instructors == 1/*operand here*/))
            {
                Assert.IsTrue(true);
            }
            else
            ...
            if ((/*operand here*/students == 13/*operand here*/) || (/*operand here*/instructors == 1/*operand here*/))
            {
                Assert.IsTrue(true);
            }
            else
        ...
        public void Switch()
        {
            ...
            number = 28; //Assign me so I cause the next switch to pass.
            switch (number)
            {
                case 15:
                    Assert.IsTrue(false);
        ...
        public void Loops()
        {
            ...
            int counter = 14;  // Change me to get in.
            ...
            do
            {
                ...
                count++;
            } while (count < 10/* write an expression here to get the loop to continue to run.*/);
